...
*/
test.skip('Replacing a DOUBLE_WALKOVER with an outcome including score will remove advanced participants', () => {
...
*/
test.only('Removing a scored outcome will remove a WALKOVER advanced participant from subsequent matchUp', () => {
  const drawProfiles = [{ drawSize: 4 }];
  const {
    tournamentRecord,
    drawIds: [drawId],
