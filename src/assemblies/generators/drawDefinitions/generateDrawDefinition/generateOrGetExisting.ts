...
export function generateOrGetExisting(params: GenerateOrGetExisting): ResultType & {
  ...
  const setUpResult = setUp(params);
  ...
  const existingQualifyingPlaceholderStructureId = setUpResult.existingQualifyingPlaceholderStructureId;
...
function setUp(params): ResultType & {
