...
export const drawDefinitionConstants = {
  ALTERNATE, WILDCARD, DIRECT_ACCEPTANCE, EXISTING_PARTICIPANT,
  MISSING_DRAW_DEFINITION, INVALID_STAGE, MAIN, QUALIFYING, CONSOLATION,
  ITEM, CONTAINER, WINNER, LOSER, FEED_IN, COMPASS, PLAYOFF, OLYMPIC,
  KNOCKOUT, ELIMINATION, DOUBLE_ELIMINATION, FMLC, CURTIS, FICSF, FICQF,
  FICR16, MFIC, FEED_IN_CHAMPIONSHIP, ROUND_ROBIN, ROUND_ROBIN_WITH_PLAYOFF,
  BACKDRAW, COMPASS_NAMING, DRAW, RANDOM, TOP_DOWN, BOTTOM_UP, WATERFALL,
