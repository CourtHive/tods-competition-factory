...
export function playOffStructures({
  ...
  const structureName = (playOffNaming && playOffNaming[exitProfile]) || finishingPositionRange;
  ...
  const roundsToPlayOff = roundOffsetLimit ?  Math.min(roundOffsetLimit - roundOffset, rounds) :
