export const FORMAT_STANDARD = 'SET3-S:6/TB7';  // Best of 3 Sets to 6 with Advantage
...
// export const FORMAT_TEAM_TENNIS = 'SET5-S:5NOAD/TB9NOAD@4'; // 
export const FORMAT_PRO_SET = 'SET1-S:8/TB7'; // One Set to 8 with Advantage with tiebreak at 8-8
export const FORMAT_COLLEBE_PRO_SET = 'SET1-S:8/TB7@7'; // One Set to 8 with tiebreak at 7-7
