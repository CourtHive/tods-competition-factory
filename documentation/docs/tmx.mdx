...
TMX is a comprehensive, open-source tournament management application built on the Competition Factory. It serves as both a production-ready tournament management system and a complete reference implementation for building factory-based applications.
