...
Visualization of a Compass draw by [tods-score-grid](https://courthive.github.io/tods-score-grid/?path=/story/score-grid-draw).
...
`getAvailablePlayoffRounds()` provides valid attributes for playoff structures generation.
