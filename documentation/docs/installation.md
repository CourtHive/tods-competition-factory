...
The **Competition Factory** is built following a Test Driven Development process. There are ~300 test suites and more than 900 individual tests that run before every release.
